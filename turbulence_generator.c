...
int main(void)
{
  ...
  if (true) {
    ...
    // call to return 3 uniform grids with the 3 components of the turbulent acceleration field at requested positions
    TurbGen_get_turb_vector_unigrid_single_realisation(
        L, k_min, k_max, spect_form, power_law_exp, angles_exp, sol_weight, random_seed, PE,
        pos_beg, pos_end, n, grid_out);
